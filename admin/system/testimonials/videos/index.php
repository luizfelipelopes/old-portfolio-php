<!DOCTYPE html>
<!--
Página: See Videos Testimonials (Ver Depoimentos em Video)
...
$readTestimonials->FullRead("SELECT depoimento_id, depoimento_cover, depoimento_name, depoimento_status, depoimento_date, depoimento_video FROM " . DEPOIMENTOS . " WHERE depoimento_type = :type ORDER BY depoimento_order ASC", "type=video");
...
if (!$readTestimonials->getResult()):
    ...
    <div class="testimonial_options">       
        ...
        <div class="btn_container">
            <a title="Novo Depoimento" href="?exe=testimonials/videos/create" class="btn btn-blue icon-file radius">Novo Depoimento</a>
        </div>
    </div>
    ...
    <section class="testimonials">
        ...
        foreach ($readTestimonials->getResult() as $testimonial):
            ...
            <article attr-item="depoimento" attr-type="video" draggable="true" id="<?= $depoimento_id; ?>" class="js_item testimonials_item j_drag_active">
                ...
                <div class="embed-container testimonial_video">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/<?= $depoimento_video; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                </div>
                <div class="testimonial_info">
                    ...
                    <div class="testimonial_info_buttons">
                        <a title="Editar Post" href="?exe=testimonials/videos/create&id=<?= $depoimento_id; ?>" class="icon-edit btn btn-small btn-blue radius">Editar</a>
