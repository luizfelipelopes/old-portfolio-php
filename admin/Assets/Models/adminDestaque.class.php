...
class adminDestaque {
    ...
    public function ExeCreate(array $Data) {
        ...
        if (in_array('', $this->Data)):
            ...
            $this->Data['destaque_url'] = (!empty($url) ? $url : null);
    ...
    private function tratarDados() {
        ...
        if (!empty($this->Data['destaque_title'])):
            ...
            $this->Data['destaque_title'] = null;
            $this->Data['destaque_name'] = null;
        endif;

        if (!isset($this->Data['destaque_url'])):
            $this->Data['destaque_url'] = null;
        endif;
    ...
    private function verificarImagem() {
        ...
        if (!empty($this->Data['destaque_cover']) && is_array($this->Data['destaque_cover'])):
            ...
            $upload->Image($this->Data['destaque_cover'], $this->Data['destaque_name'], 1920, '/destaques');
    ...
    private function Create() {
        ...
        if (!$create->getResult()):
            $this->Error = ['Não foi possível cadastrar Destaque', "error"];
            $this->Result = false;
        else:
            $this->Error = ['Destaque cadastrado com Sucesso!', "success"];
            $this->Result = true;
        endif;
    }
    ...
    private function Update() {
        ...
        if (!$update->getResult()):
            $this->Error = ["Erro ao Atualizar Destaque", "error"];
            $this->Result = false;
        else:
            $this->Error = ["Destaque Atualizado com Sucesso!", "success"];
            $this->Result = true;
        endif;
    }
    ...
    private function Delete() {
        ...
        if (!$delete->getResult()):
            $this->Error = ["Erro ao Excluir Destaque", "error"];
            $this->Result = false;
        else:
            $this->Error = ["Destaque Excluído com Sucesso!", "success"];
            $this->Result = true;
        endif;
    }
