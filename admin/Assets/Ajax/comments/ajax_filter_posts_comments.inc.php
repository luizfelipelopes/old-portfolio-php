...
/**
 * ajax_filter_posts_comments.inc.php - <b>FILTRAR POSTS COMENTARIOS</b>
 * Arquivo de inclusão do ajax.php para armazenar o script de Filtro de Posts que possuem Comentários
 */
if (!empty($Post)):
