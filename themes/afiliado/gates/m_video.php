        ...
        <div class="lp_gates_video_content">
            <div class="lp_gates_video_content_yt">
                <div class="embed-container">
                    <iframe width="853" height="480" src="https://www.youtube.com/embed/<?= $GATES['video']; ?>?rel=0&amp;showinfo=0&amp;autoplay=<?= $GATES['video_autoplay']; ?>" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
