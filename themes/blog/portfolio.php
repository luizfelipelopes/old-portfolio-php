...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Meu Portfólio | Luiz Felipe Lopes</title>
        <meta name="description" content="Conheça mais sobre mim e sobre os meus projetos.">
    ...
    <body>
        ...
        <header class="container header_topo">
            ...
            <span class="fontzero fl-left main-logo-portfolio main-logo-mobile m-bottom3"><a title="FLowstate Blog" href="#">Flowstate Blog</a></span>
            <p class="contact_header">Contato WhatsApp: (38) 98816-7371</p>
            <h1 class="ds-none">Meu Portfólio | Luiz Felipe Lopes</h1>
            <div class="content al-center m-bottom5">

                <section class="bloco_apresentacao">
                    <h1 class="m-bottom3"> Conheça os meus projetos!</h1>

                <div class="projects">

                    <a href="<?=HOME . '/&theme=blog-cristao';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-gabadi2.png">
                            <div class="clear"></div>
                        </div>
                            <p>Gabadi Online</p>
                    </a>

                    <a href="<?=HOME . '/&theme=blog-saude';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-nilma-nayara-nutri2.png">
                            <div class="clear"></div>
                        </div>
                            <p>Nilma Nayara Nutri e Coach</p>
                    </a>

                    <a href="<?=HOME . '/cardapio/&theme=pizzaria';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-pizzaria-cardapio.png">
                            <div class="clear"></div>
                        </div>
                            <p>Cardápio Pizzaria</p>
                    </a>
                    
                    <a href="<?=HOME . '/&theme=pizzaria';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-pizzaria.png">
                            <div class="clear"></div>
                        </div>
                            <p>Pizzaria</p>
                    </a>

                    <a href="<?=HOME . '/&theme=ingresso';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-ingresso.png">
                            <div class="clear"></div>
                        </div>
                            <p>Conferência Avante 2018</p>
                    </a>

                    <a href="<?=HOME . '/treinamentoreal/&theme=blog-saude';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img title="" src="layout/img/projects/print-landing-page-nilma2.png">
                            <div class="clear"></div>
                        </div>
                            <p>Landing Page - Treinamento Real</p>
                    </a>

                    <a href="<?=HOME . '/&theme=afiliado';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-afiliado.png">
                            <div class="clear"></div>
                        </div>
                            <p>Hotsite de Afiliado</p>
                    </a>

                    <a href="https://play.google.com/store/apps/details?id=io.ionic.gabadi4" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-app2.png">
                            <div class="clear"></div>
                        </div>
                            <p>Gabadi App</p>
                    </a>

                    <a href="<?=HOME . '/&theme=ead';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-cet-rhema2.png">
                            <div class="clear"></div>
                        </div>
                            <p>Cet-Rhema</p>
                    </a>
                    <a href="https://carditapetes.com.br" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-cardi2.png">
                            <div class="clear"></div>
                        </div>
                            <p>Cardi Tapetes</p>
                    ...
                    <a href="<?=HOME . '/&theme=blog';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-blog.png">
                            <div class="clear"></div>
                        </div>
                            <p>Blog de Nutrição</p>
                    </a>

                    <a href="<?=HOME . '/&theme=blog-baixo';?>" target="_blank" class="projects_item">
                        <div class="video_apresentacao">
                            <img alt="" title="" src="layout/img/projects/print-site-blog-baixo.png">
                            <div class="clear"></div>
                        </div>
                            <p>Blog de Baixo</p>
                    </a>
        ...
        <div class="container al-center btn-whatsapp">
            
            <a style="font-size: 1.3em !important; background-color:#01E675; border: none; padding:20px 30px !important;" class="btn botao_apresentacao radius" title="Quero Um Site" target="_blank" href="https://api.whatsapp.com/send?phone=5538988167371&text=Ol%C3%A1,%20eu%20estou%20vindo%20da%20sua%20p%C3%A1gina.%20Gostaria%20de%20fazer%20um%20site!">
            <img src="layout/img/whatsapp.svg">
            Eu Quero Um Site!</a>
        </div>

        <section class="dobra1 container m-top3 ds-none">
            <div class="content">
        ...
        <section class="dobra_depoimentos container">
            ...
            <header class="container header_depoimentos m-bottom3">
                <div class="content">
                    <h1>O Que Falam Sobre Meus Serviços</h1>
                    <div class="clear"></div>
                </div>
        ...
        <section class="dobra_bonus container al-center m-bottom3 ds-none">
        ...
        <section class="dobra_prazo container m-bottom3 ds-none">
        ...
        <section class="dobra_demonstracao container">
            <div class="content m-top3 m-bottom3 al-center">
                <h1 class="m-bottom3">Torne mais ágil o gerenciamento do conteúdo do seu site, trazendo maior produtividade para o seu negócio. Veja mais um depoimento sobre meus serviços!</h1>
                ...
                <div class="bloco_apresentacao">
                    ...
                    <div class="container al-center btn-whatsapp last-btn">
                        <a style="font-size: 1.3em !important; background:#01E675; border: none; padding:20px 30px !important;" class="btn botao_apresentacao radius" title="Quero Um Site" target="_blank" href="https://api.whatsapp.com/send?phone=5538988167371&text=Ol%C3%A1,%20eu%20estou%20vindo%20da%20sua%20p%C3%A1gina.%20Gostaria%20de%20fazer%20um%20site!">
                        <img src="layout/img/whatsapp.svg">
                        Eu Quero Um Site!</a>
                    </div>
        ...
        <section class="dobra_garantia container m-bottom3 al-center ds-none">
            <div class="content">
        ...
        <section class="dobra_prazo2 container al-center m-bottom3 ds-none">
            <div class="content">
