<section class="container dobra_artigos">
    ...
    <header class="container">
        <div class="content">
            <h1>Receitas</h1>
            <p>Veja algumas idéias de receitas para te ajudar na hora de variar o seu cardápio. A maioria são receitas simples e práticas que você pode testar em casa. Lembre-se, nada melhor do que você testar as receitas para se adaptarem ao seu paladar. assim, a chance de você amar é muito maior.</p>
            <div class="clear"></div>
        </div>
    </header>
        ...
        <div class="artigos container">
            <div class="content flex">
                ...
                if (!empty($_SESSION['theme'])):
                    ...
                    $Pager = new Pager(HOME . '/receitas&pag=');
