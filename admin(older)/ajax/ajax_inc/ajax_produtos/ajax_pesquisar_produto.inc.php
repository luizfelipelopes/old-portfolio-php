...
/**
 * ajax_pesquisar_produto.php - <b>PESQUISAR PRODUTO</b>
 * Arquivo de inclusão do ajax.php para armazenar o script de Pesquisa do Produto em REAL-TIME
 */
$read = new Read;
$readVendas = new Read;
...
$read->ExeRead(PRODUTOS, "WHERE (produto_title LIKE '%' :like '%' OR produto_descricao LIKE '%' :like '%') ORDER BY produto_data DESC LIMIT :limit OFFSET :offset", "like={$Post['s']
