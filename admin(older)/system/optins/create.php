    ...
    <section class="container">
        ...
        <header class="container bg-body cabecalho sectiontitle sectiontitle-nomargin">
            <div class="content">
                ...
                <a class="btn btn-blue m-bottom1 radius" title="Nova Isca" href="<?= HOME . DIRECTORY_SEPARATOR . ADMIN; ?>/dashboard.php?exe=iscas/index">Meus Iscas</a>  
                <?php
                if ($id):
                    ?>
                    <a style="margin-right: 1%;" class="btn btn-green radius" title="Nova Isca" href="<?= HOME . DIRECTORY_SEPARATOR . ADMIN; ?>/dashboard.php?exe=iscas/create">Novo Isca</a>    
                    <?php
                endif;
                ?>
...
//              DATE_FORMAT(isca_date, '%d/%m/%y %H:%i:%s') AS 
                $read->FullRead("SELECT isca_id, isca_name, isca_title, isca_file, isca_url, isca_cover, isca_author, isca_type, isca_date FROM " . ISCAS . " WHERE isca_id = :id", "id={$id}");
...
//                    die;
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="container bg-body iscas-novo">
                    ...
                    <div class="content">
                        ...
                        <label class="form-field">
                            <span class="form-legend">Upload de Arquivo:</span>
                        ...
                        <label class="form-field">
                            ...
                            <input type="text" title="Url do Arquivo" name="isca_title" placeholder="Digite uma Url" value="<?= (!empty($isca_url) ? $isca_url : null ); ?>" />
                        </label>
                ...
                <div class="iscas-lateral">
                        ...
                        <div class="content">
                            ...
                            <label class="form-field fl-left">
                                ...
                                <select name="isca_type">
                                    ...
                                    <option <?= (!empty($isca_type) ? 'selected' : '' ); ?> value="ebook">Selecione um tipo de Isca</option>
                                    <option <?= (!empty($isca_type) ? 'selected' : '' ); ?> value="planilha">Selecione um tipo de Isca</option>
                                    <option <?= (!empty($isca_type) ? 'selected' : '' ); ?> value="video">Selecione um tipo de Isca</option>
                                    <option <?= (!empty($isca_type) ? 'selected' : '' ); ?> value="pdf">Selecione um tipo de Isca</option>
                    ...
                    <div class="container iscas-publicar bg-body">
