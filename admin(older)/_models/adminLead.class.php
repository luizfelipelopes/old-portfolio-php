...
class adminLead {
    ...
    private function Create() {
        ...
        if (!$create->getResult()):
            $this->Error = ['Não foi possível cadastrar Lead', WS_ERROR];
            $this->Result = false;
        else:
            $this->Error = ['Lead cadastrado com Sucesso!', WS_ACCEPT];
            $this->Result = true;
        endif;
    }
    ...
    private function Update() {
        ...
        if (!$update->getResult()):
            $this->Error = ["Erro ao Atualizar Lead", WS_ERROR];
            $this->Result = false;
        else:
            $this->Error = ["Lead Atualizado com Sucesso!", WS_ACCEPT];
            $this->Result = true;
        endif;
    }
    ...
    private function Delete() {
        ...
        if (!$delete->getResult()):
            $this->Error = ["Erro ao Excluir Lead", WS_ERROR];
            $this->Result = false;
        else:
            $this->Error = ["Lead Excluído com Sucesso!", WS_ACCEPT];
            $this->Result = true;
        endif;
    }
