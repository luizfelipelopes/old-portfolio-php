...
<section class="container posts">
    <div class="content">
        ...
        <div class="posts_demais container">
            ...
            <?php
            $readPost = new Read();
            $readPost->ExeRead(POSTS, "WHERE post_status = 1 ORDER BY post_date DESC LIMIT :limit OFFSET :offset", 'limit=3&offset=6');
                    ...
                    <article class="post_item">
                        ...
                        <span class="post_item_content">
                            <a title="" href="<?= HOME . DIRECTORY_SEPARATOR . $post_name . '/&theme=' . THEME; ?>">
                                <h1 itemprop="name"><?= $post_title; ?></h1><?php $CategoriaNome = BuscaRapida::buscarCategoria($post_category); ?>
