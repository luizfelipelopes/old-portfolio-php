<?php
$readPost = new Read;
$readPost->FullRead("SELECT post_title, post_name, post_content, post_date, post_cover, post_category FROM " . POSTS . " WHERE post_status = 1 ORDER BY post_date DESC, post_views DESC LIMIT 3");
    ...
    <section class="container posts_mais_vistos">
        ...
        <div class="content">
            ...
            <header class="m-bottom3">
                <h1 class="title fontsize1">Mais Vistos</h1>
