    ...
    <div class="content">
        ...
        <div class="lp_confirm_share">
            <p class="lp_confirm_share_title">Compartilhe com seus amigos:</p><div class="lp_confirm_share_items">
                <iframe src="https://www.facebook.com/plugins/share_button.php?href=<?= HOME; ?>&layout=button_count&size=large&mobile_iframe=true&width=143&height=28" width="156" height="40" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                <iframe src="https://platform.twitter.com/widgets/tweet_button.html?size=l&url=<?= HOME; ?>&via=<?= $SEO['twitter']; ?>&text=<?= strip_tags($OPTIIN['headline']); ?>" width="77" height="40" title="Enviar para o Twitter!" style="border:none;overflow:hidden" frameborder="0" allowTransparency="true"></iframe>
            </div>
        </div>
    </div>
</article>
...
<!--<section class="lp_social lp_confirm_social">
    <div class="content">
        ...
        <?php // require './_cdn/app_campaign/require/reviews.php'; ?>
    </div>
</section>-->