...
<div class="lpoptin_modal j_optin_modal">
    <div class="lpoptin_modal_box">
        ...
        <?php require './_cdn/app_campaign/require/formac.php'; ?>
    </div>
</div>
            ...
            <div class="lp_video_content">
                ...
                <div class="lp_video_content_yt">
                    <div class="embed-container">
                        <iframe width="853" height="480" src="https://www.youtube.com/embed/<?= $OPTIIN['yt_video']['captura']; ?>?rel=0&amp;showinfo=0&amp;autoplay=1" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
